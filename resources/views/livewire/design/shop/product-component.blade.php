<div>
    ...
    <div class="row">
        ...
        <div class="product text-center">
            ...
            <div class="badge text-white badge-"></div><a class="d-block" href="{{route('shop.details' , $product->id)}}"><img class="img-fluid w-100" src="design/img/product-1.jpg" alt="..."></a>
            ...
            <h6> <a class="reset-anchor" href="{{ route('shop.details' , $product->id) }}">{{ $product->name }}</a></h6>
